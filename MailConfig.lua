return {
    ...
    ITEMS = {
        ...
        ["Gargantuan Machine Hippomelon Egg"] = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Exclusive Space Egg"]               = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},

        ["Gargantuan Machine Egg 1"]          = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Gargantuan Machine Egg 2"]          = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Gargantuan Machine Egg 3"]          = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Gargantuan Machine Egg 4"]          = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Gargantuan Machine Egg 5"]          = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Gargantuan Machine Egg 6"]          = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ...
        ["Huge Machine Egg 1"]                 = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Huge Machine Egg 2"]                 = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Huge Machine Egg 3"]                 = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Huge Machine Egg 4"]                 = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Huge Machine Egg 5"]                 = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},
        ["Huge Machine Egg 6"]                 = {Class = "Egg", Id = "Egg", MinAmount = 1, KeepAmount = 0},

        ["Hype Egg"]                           = {Class = "Lootbox", Id = "Hype Egg", MinAmount = 1, KeepAmount = 0},
        ["Hype Egg 2"]                         = {Class = "Lootbox", Id = "Hype Egg 2", MinAmount = 1, KeepAmount = 0},
        ...
        ["Mega Potion Chest"]                  = {Class = "Lootbox", Id = "Mega Potion Chest", MinAmount = 1, KeepAmount = 0},
        ["Mega Enchant Chest"]                 = {Class = "Lootbox", Id = "Mega Enchant Chest", MinAmount = 1, KeepAmount = 0},
        ...
        ["Coins Charm"]                        = {Class = "Charm", Id = "Coins", MinAmount = 1700, KeepAmount = 0},    --price 3k
        ["Criticals Charm"]                    = {Class = "Charm", Id = "Criticals", MinAmount = 1700, KeepAmount = 0}, --price 3k
        ["TNT Charm"]                          = {Class = "Charm", Id = "TNT", MinAmount = 500, KeepAmount = 0},       --price 10k
        ["Diamonds Charm"]                     = {Class = "Charm", Id = "Diamonds", MinAmount = 600, KeepAmount = 0},  --price 8k
        ["XP Charm"]                           = {Class = "Charm", Id = "XP", MinAmount = 25, KeepAmount = 0},          --price 193k

        ["Magic Shard"]                        = {Class = "Misc", Id = "Magic Shard", MinAmount = 50, KeepAmount = 0},    --price 77k
        ["Insta Plant Capsule"]                = {Class = "Misc", Id = "Insta Plant Capsule", MinAmount = 200, KeepAmount = 0}, --24k

        ["Crystal Key"]                        = {Class = "Misc", Id = "Crystal Key", MinAmount = 600, KeepAmount = 0},       --price 8.0k
        ["Secret Key"]                         = {Class = "Misc", Id = "Secret Key", MinAmount = 400, KeepAmount = 0},        --price 11.8k
        ["Fantasy Key"]                        = {Class = "Misc", Id = "Fantasy Key", MinAmount = 150, KeepAmount = 0},       --price 35.8k
        ["Tech Key"]                           = {Class = "Misc", Id = "Tech Key", MinAmount = 250, KeepAmount = 0},          --price 20k
        ["Void Key"]                           = {Class = "Misc", Id = "Void Key", MinAmount = 250, KeepAmount = 0},          --price 21.5k
        ["Prison Key"]                         = {Class = "Misc", Id = "Prison Key", MinAmount = 50, KeepAmount = 0},          --price 128k
        ["Hacker Key"]                         = {Class = "Misc", Id = "Hacker Key", MinAmount = 50, KeepAmount = 0},          --price 110k
        ["Treasure Hideout Key"]               = {Class = "Misc", Id = "Treasure Hideout Key", MinAmount = 550, KeepAmount = 0}, --price 9.1k
        ["Golden Prison Key"]                  = {Class = "Misc", Id = "Golden Prison Key", MinAmount = 25, KeepAmount = 0},   --price 197k
    }
}
